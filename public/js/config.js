...
window.globalAdminRoutes = {

    
//    '(dashboard|calendar|profile)': 'pages/$1.html',
    '(map-manual)' : 'pages/manual/html/$1.html',
    '(map-mechanical)' : 'pages/mechanical/html/$1.html'
//    'globalmail' : 'pages/globalmail/main.html'
//        '(pricing-tables|form-plugin|discount-labels|tiles|dropdown-enhancement|wizard|buttons|default-elements|form-basic-elements|form-custom-elements|dashboard|mailbox|glyphicon|typography|font-awesome|weather-icons|error-404|error-500|globalpanel|globaltab|globalbox|helper)' : 'pages/$1.html',
};

/**
 * EVENTS
 * Using events 
 * $('body').on('eventName.globalAdmin', function(event, globalAdmin){
 *      
 * });
 * 
 * First parameter to every event is Event object.
 * Second parameter is globalAdmin instance.
